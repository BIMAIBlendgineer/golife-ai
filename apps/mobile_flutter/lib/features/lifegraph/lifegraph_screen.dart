...
String _memorySearchBody(AppLocalizations l10n) => pickLocalizedValue(
      ...
      ptBr:
          'Busque primeiro e depois ajuste por domínio, tempo ou privacidade.',
      ptPt:
