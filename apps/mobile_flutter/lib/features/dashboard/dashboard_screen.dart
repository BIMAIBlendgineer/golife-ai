...
String _todayEmptyTitle(AppLocalizations l10n) => pickLocalizedValue(
  ...
  es: 'Todavia no se suficiente de tu dia.',
...
String _todayEmptyBody(AppLocalizations l10n) => pickLocalizedValue(
  ...
  es: 'Captura una frase y GoLife la convertira en el siguiente paso claro.',
  ptBr: 'Capture uma frase e o GoLife a transformara no proximo passo claro.',
...
String _capturePromptBody(AppLocalizations l10n) => pickLocalizedValue(
  ...
  es: 'Capture mantiene Today fresco sin abrir todos los modulos.',
...
String _dataUsedBody(AppLocalizations l10n) => pickLocalizedValue(
  ...
  es: 'Primero evidencia visible, despues detalle tecnico.',
...
String _nothingSentLabel(AppLocalizations l10n) => pickLocalizedValue(
  ...
  es: 'No se envio nada a la IA para esta mision.',
